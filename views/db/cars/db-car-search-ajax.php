...
if (pg_num_rows($result) > 0) {
    while ($car = pg_fetch_assoc($result)) {
        ...
        echo '<p>' . $car['car_brand'] . '</p>';
        echo '<p>' . $car['car_model'] . '</p>';
        echo '<p>' . $car['car_price_per_day'] . '</p>';
        echo '<p>' . $car['car_doors'] . '</p>';
        echo '<p>' . $car['car_seats'] . '</p>';
        echo '<p>' . $car['car_space_bags'] . '</p>';
        echo '<p>' . $car['car_fuel'] . '</p>';
        echo '<p>' . $car['car_unlimited_mileage'] . '</p>';
        echo '<p>' . $car['car_free_cancellation'] . '</p>';
        echo '<p>' . $car['car_min_age'] . '</p>';
        echo '<p>' . $car['car_active'] . '</p>';
